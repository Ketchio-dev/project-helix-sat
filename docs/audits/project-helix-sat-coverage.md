...
- Items: 44
- Rationales: 44
- Sections: math=21, reading_writing=23
- Domains: math:advanced_math=6, math:algebra=7, math:geometry_and_trigonometry=4, math:problem_solving_and_data_analysis=4, reading_writing:craft_and_structure=7, reading_writing:expression_of_ideas=4, reading_writing:information_and_ideas=8, reading_writing:standard_english_conventions=4
...
### Missing skills
- reading_writing/standard_english_conventions/punctuation

### Partial skills
- reading_writing/expression_of_ideas/organization (2 mapped items)
...
## Major risks
- Missing explicit blueprint skills: reading_writing:punctuation
